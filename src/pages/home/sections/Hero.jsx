        ...
        <div className='hero' id='hero'>
            <div className="container">
                <div className='header row between align-center'>
                    ...
                    <nav className="nav row align-center">
                        ...
                        <a className='nav__link btn' href="https://qabul.edusharq.uz/">Ariza topshirish</a>
                    </nav>
                ...
                <div className="main">
                    <div className="wrapper">
                        ...
                        <div className="main__btns">
                            <a className='btn' href="https://qabul.edusharq.uz/">Ariza topshirish</a>
            ...
            >
                <nav className="nav-drawer flex-column">
                    ...
                    <a className='link btn' href="https://qabul.edusharq.uz/">Ariza topshirish</a>
                </nav>
            </Drawer>
        </div>
    );
